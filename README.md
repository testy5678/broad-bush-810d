...
```
npm create cloudflare@latest -- --template=cloudflare/templates/broad-bush-810d
```

## Preview Deployment

A live public deployment of this template is available at [https://broad-bush-810d.templates.workers.dev](https://broad-bush-810d.templates.workers.dev)
